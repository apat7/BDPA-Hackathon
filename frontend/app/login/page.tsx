    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 p-8 animate-scale-in hover:shadow-3xl transition-all duration-500">
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-4 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 flex items-center gap-2 text-red-600 dark:text-red-400 text-sm animate-fade-in-up">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white font-semibold border-2 border-slate-300 dark:border-slate-600 hover:border-blue-500 dark:hover:border-blue-400 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 transform flex items-center justify-center gap-2 mb-5 animate-fade-in-up animate-delay-300"
          >
          ...
          {/* Divider */}
          <div className="relative mb-5 animate-fade-in-up animate-delay-300">
          ...
          <form
            ...
            className="space-y-5 animate-fade-in-up animate-delay-300"
          >
            {!isLogin && (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform animate-fade-in-up animate-delay-400 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
